  ...
  return class Particles {
    constructor (target, options) {
      ...
      if (!target || target.tagName.toLowerCase() !== 'canvas') {
        ...
        this.Particle = ParticleInit(this.options)
    ...
    initialize () {
      ...
      this.particles = new Array() // eslint-disable-line
      for (let i = 0; i < nbParticles; i++) {
        this.particles.push(new this.Particle(this.target.offsetWidth, this.target.offsetHeight))
      }
